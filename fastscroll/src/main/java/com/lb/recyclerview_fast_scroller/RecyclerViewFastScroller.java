...
public class RecyclerViewFastScroller extends LinearLayout {
    ...
    private void setViewsToUse(@LayoutRes int layoutResId, @IdRes int scrollbar, @IdRes int bubbleResId, @IdRes int handleResId) {
        final LayoutInflater inflater = LayoutInflater.from(getContext());
        inflater.inflate(layoutResId, this, true);
        bubble = (TextView) findViewById(bubbleResId);
        if (bubble != null)
    ...
    public void setRecyclerView(final RecyclerView recyclerView) {
        if (this.recyclerView != recyclerView) {
            ...
            setViewsToUse(R.layout.fast_scroll_layout, R.id.scrollbar, R.id.fastscroller_bubble, R.id.fastscroller_handle);
        }
    }
    ...
    private void setRecyclerViewPosition(float y) {
        if (recyclerView != null) {
            ...
            CharSequence bubbleText = null;
            if (!(recyclerView.getAdapter() instanceof IPopupNameView)) {
                bubbleText = "";
            }else{
                IPopupNameView popupName = (IPopupNameView) recyclerView.getAdapter();
                bubbleText = popupName.getLabel(targetPos);
            }
            if (bubble != null)
